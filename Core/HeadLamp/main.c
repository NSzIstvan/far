...
//};
///* Definitions for light_app */
//osThreadId_t light_appHandle;
//const osThreadAttr_t light_app_attributes = {
//  .name = "light_app",
//  .stack_size = 128 * 4,
//  .priority = (osPriority_t) osPriorityNormal,
//};
...
//void cyclic_10ms(void *argument);
...
//
//  /* creation of light_app */
//  light_appHandle = osThreadNew(cyclic_10ms, NULL, &light_app_attributes);
//
...
//  Task_100msHandle = osThreadNew(runTask50ms, NULL, &Task_100ms_attributes);
//
...
//}
//
///* USER CODE BEGIN Header_cyclic_10ms */
///**
//* @brief Function implementing the light_app thread.
//* @param argument: Not used
//* @retval None
//*/
///* USER CODE END Header_cyclic_10ms */
//void cyclic_10ms(void *argument)
//{
//  /* USER CODE BEGIN cyclic_10ms */
//  /* Infinite loop */
//  for(;;)
//  {
//    osDelay(10);
//  }
//  /* USER CODE END cyclic_10ms */
//}
//
