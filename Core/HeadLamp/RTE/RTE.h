...
#define RTE_Call_Move_Motor_Steps(val, val2) RTE_Call_MotorApp_MotorControl_Move_Motor_Steps(val, val2)
...
#define RTE_Write_Leveling_Pot_Value(val) RTE_Write_CommandControl_MotorApp_Leveling_Pot_Value(val)
...
#define RTE_Write_Motor_Movement_Finished(val) RTE_Write_MotorControl_MotorApp_Motor_Movement_Finished(val)

#define RTE_Read_Light_Command_Rotary_Switch_Value() RTE_Read_CommandApp_CommandControl_Light_Command_Rotary_Switch_Value()
#define RTE_Read_Leveling_Pot_Value() RTE_Read_CommandControl_MotorApp_Leveling_Pot_Value()
